...
export class MyGroupsComponent implements OnInit {
  ...
  constructor(private httpAccountService: HttpAccountService, private httpGroupService: HttpGroupService) { }
  ...
  getOwnGroups() {
    ...
    this.groups = this.httpAccountService.getOwnGroups(principal.id).subscribe((res: any) => {
      this.groups = res;
