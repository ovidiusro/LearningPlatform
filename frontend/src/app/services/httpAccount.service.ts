...
export class HttpAccountService {
  ...
  signIn(credentials) {
    return this.http.post(this.rootUrl + "/sign-in", credentials, {
      headers: this.noAuthReqHeader,
    });
  }
  signUp(registerForm) {
    return this.http.post(this.rootUrl + "/sign-up", registerForm, {
      headers: this.noAuthReqHeader,
    });
  }
  ...
  getUserByUsername(username) {
    return this.http.get(this.rootUrl + "/username/" + username, {
      headers: this.noAuthReqHeader,
    });
  }
  ...
  setAvatar(idAccount, idFile) {
    return this.http.post(
      this.rootUrl + "/avatar?accountId=" + idAccount + "&fileId=" + idFile,
      idAccount
    );
  }
  getAvatar(idAccount) {
  ...
  getUserByEmail(email) {
    return this.http.get(this.rootUrl + "/email/" + email, {
      headers: this.noAuthReqHeader,
    });
  }
