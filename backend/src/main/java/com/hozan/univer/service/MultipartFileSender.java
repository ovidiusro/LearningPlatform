...
public class MultipartFileSender {
    ...
    public static MultipartFileSender fromInputStreamAndFile(InputStream inputStream,File file) {
        return new MultipartFileSender().setInputStreamAndFile(inputStream, file);
    }

    //** internal setter **//

    public MultipartFileSender setInputStreamAndFile(InputStream inputStream, File file) {
