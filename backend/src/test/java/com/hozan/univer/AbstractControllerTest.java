...
import com.hozan.univer.web.api.BaseController;
...
public abstract class AbstractControllerTest extends AbstractTest {
     ...
     * Mockito resources into the web class.
     * @param controller A web object to be tested.
     */
    ...
    /**
     * Maps a String of JSON into an instance of a Group of type T. Uses a
     * Jackson ObjectMapper.
     * @param json A String of JSON.
     * @param clazz A Group of type T. The mapper will attempt to convert the
     *        JSON into an Object of this Group type.
